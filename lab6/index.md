...
## Table of Contents
1. [Goal](#goal)
2. [Setting Up the Environment](#paragraph1)
...
Loading OSM dataset to PostGIS server
...
Loading RA dataset to PostGIS server 
...
Resilience Academy Waste Site Data
...
Creating blocked waterway buffer
